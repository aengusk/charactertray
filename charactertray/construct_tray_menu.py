...
tray_menu_icon = Icon('aengus_character_tray_icon', image, 'Aengus Character Tray')
...
tray_menu_icon.menu = Menu(quit_item, copy_to_clipboard_item, open_file_explorer_item, *all_menu_items)
